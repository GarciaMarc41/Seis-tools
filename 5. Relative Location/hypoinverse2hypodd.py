...
if __name__ == '__main__':
    ...
    input_file = '/Users/marcgarcia/Research/Relocation/hyp1.40/RAPID/RAPID/m1/hypoOut.arc'
    output_file = '/Users/marcgarcia/Research/Relocation/HYPODD/RAPID/RAPID/m1/hypoDD.pha'
    rms_threshold=300 # in sec, events with rms larger than this will not be used
    gap_threshold=3000 # in deg., events with station gap larger than this will not be used
    pick_nres=300       # if pick's residual larger than nres times event's rms
                        # the pick will not be used
    maxdep=1350 # in km, events with larger depth will not be used (< dep in the timetable)
    maxdep_err=1000 # in km, events with larger depth uncertainty will not be used
    maxdis_err=1000 # in km, events with larger horizontal uncertainty will not be used
